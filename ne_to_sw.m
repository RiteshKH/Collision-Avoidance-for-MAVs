...
% xtrue(3)
    ...
    if((isempty([x_i y_i])~=1)&&(flag~=1))
        ...
        ang1 = (atan2((y_i(1) - xtrue(2)),(x_i(1) - xtrue(1))));
        ang2 = (atan2((y_i(2) - xtrue(2)),(x_i(2) - xtrue(1))));
        if (ang1<ang2)
            temp = ang1;
            ang1 = ang2;
            ang2 = temp;
        ...
        deltaG= (atan2(ep(2)-xtrue(2), ep(1)-xtrue(1)) - xtrue(3));
...
xtrue= vehicle_model2(xtrue, V,G,dt);
xt= TransformToGlobal2(veh,xtrue); 
xt2 = TransformToGlobal2(field,xtrue);
